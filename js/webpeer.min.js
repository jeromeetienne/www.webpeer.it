...
1;if(!(j>0)){var u=d();f(u)}};for(var q in k)m({app_suffix:q,nocache:e,success_cb:p,failure_cb:p})};o.discover_app=m;o.discover_webpeer=i;o.cache_contain=c;o.cache_get=function(e){return a[e]};o.cache_clear=b;o.avail=function(e){if(!c(e))return false;if(a[e].version==false)return false;return true};o.probe=m;o.webpeer_probe=i;o.webpeer_avail=function(){return d()=="installed"};o.webpeer_status=d;o.clear=b});s.module("./neoip_jsonp_call",function(o){var h=0;o.jsonp_call=function(g){var l=g.url||console.assert(g.url),
...
from_string:k}};a.create=function(c){return new a(c)};o.url_builder_oload_t=a;o.create=a.create});s.module("./webpeer",function(o,h){var g=h("./neoip_app_detect"),l=h("./url_builder_oload_t"),a={};a.ready=function(c){g.webpeer_probe({completed_cb:function(b){if(b=="toinstall")c(false);else if(b=="toupgrade")c(true);else b=="installed"?c(true):console.assert(false)}})};a.avail=function(){return g.webpeer_status()=="installed"};a.url=function(c){if(!a.avail())return c;return l.create(c).set("outter_uri",
g.cache_get("oload").root_url).to_string()};a.monitor=function(c){if(typeof c=="function")c={completed_cb:c};var b=c.completed_cb||function(){},m=c.delay||1E3,n=null,k=function(){g.webpeer_probe({completed_cb:function(d){if(d!=n){n=d;b(d)}setTimeout(k,m)},nocache:true})};setTimeout(k,0)};a.badge=function(){a.ready(function(){var c=document.getElementById("webpeer_badge");c.src="http://webpeer.it/images/badge/"+(a.avail()?"accept.png":"exclamation.png");c.title=a.avail()?"You are a web peer. Welcome!":
